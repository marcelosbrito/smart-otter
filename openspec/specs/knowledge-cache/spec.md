...
**Purpose:** Cache successful AI responses keyed by search query and serve cached results for repeated searches without invoking the AI provider, achieving sub-second response times.
