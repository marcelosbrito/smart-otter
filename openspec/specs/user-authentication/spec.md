...
**Purpose:** Authenticate users via Clerk (email and social providers) while allowing unauthenticated visitors to access public search features without an account.

## Requirements

### Requirement: User Authentication via Clerk

The system MUST use Clerk to authenticate users via email and social providers (Google, GitHub) while allowing unauthenticated visitors to access public search features.
